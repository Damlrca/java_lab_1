package org.example.java_lab_1;
...
public class Lab1_Controller {
    ...
    void init_circles() {
        ...
        target_1.setLayoutY(line_1.getLayoutY() + get_coord_y(pos_t1) + 50);

        pos_t2 = 125;
        target_2.setLayoutX(line_2.getLayoutX());
        target_2.setLayoutY(line_2.getLayoutY() + get_coord_y(pos_t2) + 50);
    }
    void move_circles() {
    ...
    Boolean game_pause = false, game_run = false;
    ...
    void delete_bullet() {
        // fill="#ff7300" layoutX="119.0"
        // layoutY="103.0" radius="9.0"
